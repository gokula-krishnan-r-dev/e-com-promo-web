...
import Joi from "joi";
import { formFieldsAnniversary } from "@/content/coupon/gene-form";
...
const formSchema = Joi.object({
  ...
  anniversaryMonth: Joi.string().required().messages({
...
const AnniversayCouponForm: React.FC<any> = ({ method, defaultValue }: any) => {
  ...
  const validate = (): boolean => {
    // Ensure formData is an array; if not, use an empty array
  ...
  return (
    ...
    >
      {formFieldsAnniversary.map((field) => {
...
export default AnniversayCouponForm;
